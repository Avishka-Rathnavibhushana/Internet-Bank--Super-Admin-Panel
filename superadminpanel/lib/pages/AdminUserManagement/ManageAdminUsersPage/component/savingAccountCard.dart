...
class SavingAccountCard extends StatefulWidget {
  SavingAccountCard({Key? key}) : super(key: key);

  @override
  State<SavingAccountCard> createState() => _SavingAccountCardState();
}

class _SavingAccountCardState extends State<SavingAccountCard> {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              CustomText(
                  color: Colors.black54, text: "Account Number", fontSize: 15),
              SizedBox(
                width: 30,
              ),
              Container(
